...
measurements for each reporting count in the United States. This included the 
...
The Air Quality Life Index (AQLI) by EPA comprised a time series containing
measurements of population-weightedatmospheric particulate pollution 
(particulate mater (PM) 2.5 micograms per cubic meter or less), which is the 
